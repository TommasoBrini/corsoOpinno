...
-- Non dimenticare la condizione di where! UPDATE public.impiegati SET nome='Simone';

-- HO errore perché ho chiavi esterne che referenziano la tabella DELETE from impiegati; 
